...
/*
 *  This file is part of SYMBOLICORE.
 *
 *  SYMBOLICORE is free software: you can redistribute it and/or modify
 *  it under the terms of the GNU General Public License as published by
 *  the Free Software Foundation, either version 3 of the License, or
 *  (at your option) any later version.
 *
 *  SYMBOLICORE is distributed in the hope that it will be useful,
 *  but WITHOUT ANY WARRANTY; without even the implied warranty of
 *  MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
 *  GNU General Public License for more details.
 *
 *  You should have received a copy of the GNU General Public License
 *  along with SYMBOLICORE.  If not, see <https://www.gnu.org/licenses/>.
 */
...
#ifndef SYMBOLICORE_VECTOR_HPP
#define SYMBOLICORE_VECTOR_HPP
...
public:
    ...
    static Vector<X> unit(SizeType n, SizeType i, PRS... prs) {
        SYMBOLICORE_ASSERT(i<n); Vector<X> result(n,X(0u,prs...)); result[i]=X(1u,prs...); return result; }
    //! \brief The unit vector \f$e_i\f$ with value one in the \a i<sup>th</sup> entry, and zero otherwise.
    template<class... PRS> requires Constructible<X,Nat,PRS...>
    ...
    X& at(SizeType i) { SYMBOLICORE_PRECONDITION_MSG(i<this->size(),*this<<"["<<i<<"]"); return (*this)[i]; }
    //! \brief A constant reference to the value stored in the \a i<sup>th</sup> element.
    const X& at(SizeType i) const { SYMBOLICORE_PRECONDITION_MSG(i<this->size(),*this<<"["<<i<<"]"); return (*this)[i]; }
    ...
    VectorRange<Vector<X>> operator[](Range rng); // { SYMBOLICORE_PRECONDITION_MSG(rng.stop()<this->size(),*this<<"["<<r<<"]"); return VectorRange<X>(*this,rng); }
...
public:
    ...
    template<class VE> VectorRange<V>& operator=(const VectorExpression<VE>& ve) {
        SYMBOLICORE_PRECONDITION(this->size()==ve().size());
